...
<body>
    <h2>환불 인증번호 입력</h2>
    <form id="refundVerificationForm">
        ...
        <button type="button" onclick="submitRefundVerification()">확인</button>
        <button type="button" onclick="window.close()">취소</button>
    </form>
    <script src="/resources/js/pay_refund.js"></script> <!-- 환불 관련 JS 파일 -->
</body>
</html>